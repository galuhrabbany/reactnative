  ...
  const saveData = () => {
    ...
    push(refDB, {
      ...
      .then(() => {
        ...
        setName(""); setCategory(""); setAddress("");
        setLatitude(""); setLongitude(""); setAccuracy("");
        setOpenHours(""); setPriceRange(""); setMenuTop("");
      })
      .catch((e) => {
        console.error(e);
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: "700", marginBottom: 20, textAlign: "center", color: "#245c44" },
